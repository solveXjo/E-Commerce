            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="single-product-img">
                        <img src=<?= Yii::getAlias('@web/assets/img/products/product-img-5.jpg') ?> alt="">
                    </div>
                </div>
                <div class="col-md-7">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img src=<?= Yii::getAlias('@web/assets/img/products/product-img-1.jpg') ?> alt=""></a>
                        </div>
                        <h3>Strawberry</h3>
